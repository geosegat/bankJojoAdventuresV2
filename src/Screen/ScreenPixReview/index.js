...
const ScreenPixReview = ({navigation}) => {
  ...
  const pixValue = useSelector(state => state.cpfPixReceived.valuePixReceived);
  const namePixReceived = useSelector(
    ...
    <View style={styles.container}>
      ...
      <View style={styles.flex}>
        <View style={styles.cardValueInputUser}>
          ...
          <AppText size="huge" variant="bold">{`R$ ${pixValue}`}</AppText>
          <AppText style={styles.styleMargin2}>{namePixReceived} </AppText>
        </View>
